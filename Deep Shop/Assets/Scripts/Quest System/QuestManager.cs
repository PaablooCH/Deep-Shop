...
public class QuestManager : MonoBehaviour, IPersistenceData
{
    ...
    private void Start()
    {
        ...
        {
            GameEventsMediator.instance.questEvents.QuestStateChange(quest);
        }
    ...
    {
        GameEventsMediator.instance.questEvents.onStartQuest += StartQuest;
        ...
        GameEventsMediator.instance.questEvents.onQuestSegmentStateChange += UpdateSegmentState;

        GameEventsMediator.instance.inventoryEvent.onKarmaChanged += UpdateKarma;
    }
    ...
    {
        PlayerManager.instance.GetPlayerInventory().Money += quest.QuestInfo.MoneyReward;
        PlayerManager.instance.GetPlayerInventory().ModifyInventory(quest.QuestInfo.ProductReward.itemInfo.IdItem,
