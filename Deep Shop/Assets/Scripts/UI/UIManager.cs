...
// TODO create a new file with the enum
public enum UIs
{
    MENU, 
    SHOP, 
...
public class UIManager : MonoBehaviour
{
    ...
    public void OpenUI<T>(UIs ui, T obj)
    {
        switch (ui)
        {
            case UIs.MENU:
                _menuUI.GetComponent<MenuWindowUI>().OpenUI();
                break;
            case UIs.SHOP:
                _shopUI.GetComponent<ShopUI>().OpenUI(obj as GameObject);
                break;
            case UIs.TRADE:
                _tradeUI.GetComponent<TradeUI>().OpenUI(obj as Item);
                break;
            case UIs.ITEM_ACQ:
                _itemAcqUI.GetComponent<ItemsAcquiredUI>().OpenUI(obj as GameObject);
                break;
            case UIs.DIALOGUE:
                _dialogueUI.GetComponent<DialogueUI>().OpenUI();
                break;
            default:
