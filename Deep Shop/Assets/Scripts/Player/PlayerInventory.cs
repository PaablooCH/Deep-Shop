...
public class PlayerInventory : MonoBehaviour, IPersistenceData
{
    ...
    public float Karma
    {
        ...
        set
        {
            GameEventsMediator.instance.inventoryEvent.KarmaChanged(value);
            _karma = value;
        }
    }
    ...
    public float Money
    {
        ...
        set
        {
            GameEventsMediator.instance.inventoryEvent.MoneyChange(value);
            _money = value;
        }
    }
    ...
    public void ModifyInventory(string id, int n)
    {
        ...
        {
            _inventory[id] = 0;
            GameEventsMediator.instance.inventoryEvent.AddItem(id);
        }
        ...
        if (_inventory[id] > 0)
        {
            GameEventsMediator.instance.inventoryEvent.ModifyQuantity(id, _inventory[id]);
        }
        else if (_inventory[id] == 0)
        {
            GameEventsMediator.instance.inventoryEvent.RemoveItem(id);
        }
    }
